...
@Component({
  selector: 'app-cars-category',
  templateUrl: './cars-category.component.html',
  styleUrls: ['./cars-category.component.css']
})
export class CarsCategoryComponent implements OnInit {
  ...
  getTopicsFromDB() {
    return new Promise((resolve) => {
      ...
      this.db.list("data/Cars").valueChanges().subscribe(value=>{
        resolve(value);
      });
    });
  }
